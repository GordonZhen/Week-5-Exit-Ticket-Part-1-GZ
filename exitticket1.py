...
# message = f"My favorite song from the playlist is {playlist[0]}."
# print(message)
...
# print(playlist)
# print(yay_song)
Billie_Song = "Billie Jean"
playlist.remove(Billie_Song)
print(playlist)
print(Billie_Song)
# # \n = creates a new line in the code
# print(f"\n {yay_song} is a Bay Area anthem!")
print(f"\n {Billie_Song} is a Bay Area anthem!")
